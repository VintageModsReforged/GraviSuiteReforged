...
public class GuiRelocatorAdd extends GuiContainer {
    ...
    private static ResourceLocation TEXTURE = new ResourceLocation(Refs.id, "textures/gui/relocator_add.png");
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        String addText = Translator.WHITE.format("message.text.relocator.add");
