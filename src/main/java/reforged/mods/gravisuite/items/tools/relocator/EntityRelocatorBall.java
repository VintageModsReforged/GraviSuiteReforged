...
public class EntityRelocatorBall extends EntityThrowable {
    ...
    private EntityLiving ownerEntity;
    ...
    public EntityRelocatorBall(World world, EntityLiving entity, TeleportPoint point, byte actionType) {
        super(world, entity);
    ...
    protected void entityInit() {
        ...
        this.dataWatcher.func_82708_h(30);
    }
