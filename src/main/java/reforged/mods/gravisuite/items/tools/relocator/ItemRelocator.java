...
public class ItemRelocator extends ItemBaseElectricItem {
    ...
    public ItemRelocator() {
        ...
        this.ENERGY_PORTAL = GraviSuiteMainConfig.ENERGY_PORTAL;
        this.ENERGY_SHOOT = GraviSuiteMainConfig.ENERGY_SHOOT;
    }
