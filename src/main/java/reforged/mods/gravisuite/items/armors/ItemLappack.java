...
public class ItemLappack {
    ...
    public static class ItemAdvancedLappack extends ItemArmorElectric {
        ...
        public ItemAdvancedLappack() {
            super(GraviSuiteConfig.ADVANCED_LAPPACK_ID.get(),0, "advanced_lappack", EnergyValues.ADV_LAPPACK.tier, EnergyValues.ADV_LAPPACK.transfer, EnergyValues.ADV_LAPPACK.maxCapacity);
        }
    }
    ...
    public static class ItemUltimateLappack extends ItemArmorElectric {
        ...
        public ItemUltimateLappack() {
            super(GraviSuiteConfig.ULTIMATE_LAPPACK_ID.get(), 1, "ultimate_lappack", EnergyValues.ULT_LAPPACK.tier, EnergyValues.ULT_LAPPACK.transfer, EnergyValues.ULT_LAPPACK.maxCapacity);
        }
