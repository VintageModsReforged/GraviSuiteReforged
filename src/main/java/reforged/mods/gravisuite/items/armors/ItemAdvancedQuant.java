...
public class ItemAdvancedQuant extends ItemArmorElectric implements IAudioProvider {
    ...
    public ItemAdvancedQuant() {
        super(GraviSuiteConfig.ADVANCED_QUANT_ID.get(), "advanced_quant", EnergyValues.ADV_QUANT.tier, EnergyValues.ADV_QUANT.transfer, EnergyValues.ADV_QUANT.maxCapacity);
