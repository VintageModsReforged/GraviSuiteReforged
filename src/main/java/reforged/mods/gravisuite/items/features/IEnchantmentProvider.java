...
public interface IEnchantmentProvider {
    ...
    class EnchantHelper {
        ...
        public static IEnchantmentProvider.EnchantmentMode getEnch(ItemStack stack) {
        ...
        public static IEnchantmentProvider.EnchantmentMode cycleAndSave(ItemStack stack) {
            IEnchantmentProvider.EnchantmentMode current = getEnch(stack);
            IEnchantmentProvider.EnchantmentMode next = IEnchantmentProvider.EnchantmentMode.getFromId(current.ordinal() + 1);
